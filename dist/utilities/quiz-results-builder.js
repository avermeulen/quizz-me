...
var mcqCommand = function (answer, question) {
    ...
    if (!answer.correct) {
        var incorrectAnswer = _.find(question.options, (option) => option._id.toString()
...
module.exports = function (quizResults) {
    var answers = quizResults.answers, details = quizResults.details, questions = details.questions;
