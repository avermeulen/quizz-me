const mongoose = require('mongoose'), _ = require('lodash'), coify = require('../utilities/coify');
marked = require('marked'),
    render = require('../utilities/render'),
    ObjectId = mongoose.Types.ObjectId,
    reportErrors = require('../utilities/http_utilities').reportErrors;
module.exports = function (models) {
    const Course = models.Course, User = models.User, Quiz = models.Questionairre;
    ...
    var deleteQuestion = function (req, res, next) {
        var question_id = req.params.question_id, course_id = req.params.course_id;
        return function* () {
            try {
                const course = yield Course.findById(ObjectId(course_id));
                course.questions
    ...
    var deleteCourseQuestionOption = function (req, res, next) {
        const course_id = req.params.course_id, question_id = req.params.question_id, option_id = req.params.option_id;
        return function* () {
            try {
                const course = yield Course.findById(ObjectId(course_id));
                const question = course.questions.id(ObjectId(question_id));
