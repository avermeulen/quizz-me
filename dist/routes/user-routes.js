const mongoose = require('mongoose'), co = require('co'), ObjectId = mongoose.Types.ObjectId, render = require('../utilities/render'), reportErrors = require('../utilities/http_utilities').reportErrors, Services = require('./services');
module.exports = function (models) {
    ...
    const registerUserScreen = function (req, res, next) {
        ...
        var firstName = nameParts.length >= 0 ? nameParts[0] : '', lastName = nameParts.length >= 1 ? nameParts[1] : '';
