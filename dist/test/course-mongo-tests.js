var mongoose = require('mongoose'), assert = require('assert'), models = require('../models'), Promise = require('bluebird'), async = require('co'), mongooseConnect = require('./mongoose-connect');
...
function findQuestion(question) {
    return async(function* () {
        var course = yield Course.findOne({ 'questions.question': question }, { 'questions.$': 1 });
